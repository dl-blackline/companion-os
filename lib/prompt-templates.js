 ...
 *
 * @param {{ character: string, scenario: string, contextBlock: string, message: string }} ctx
 * @returns {{ system: string, user: string }}
 */
 ...
 * @returns {string}
 */
export function liveTalkSystem({ aiName = "Vuk", mode = "neutral" }) {
 ...
 * @returns {{ system: string, user: string }}
 */
export function liveTalkTask({ aiName = "Vuk", taskType, taskDescription }) {
  return {
 ...
 * @returns {{ system: string, user: string }}
 */
export function liveTalkMediaAck({ aiName = "Vuk", mediaType, prompt }) {
  return {
