...
const ANALYSIS_SYSTEM_PROMPT = `You are an advanced media analysis intelligence engine for a personal AI operating system.
  ...
  "memory_candidates": [
    {
      ...
      "content": "What the AI should remember from this media",
