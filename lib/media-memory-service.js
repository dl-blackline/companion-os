...
const ANALYSIS_SYSTEM_PROMPT = `You are an intelligent media analysis assistant for a personal AI companion.
Analyze the provided media and return a JSON object with the following fields. Respond with valid JSON only — no markdown, no explanation.

{
  "summary": "1-2 sentence overview of what this media shows",
  "description": "detailed multi-sentence description covering all notable elements",
