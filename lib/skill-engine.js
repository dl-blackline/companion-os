...
- Be specific and actionable.`,
    user: `Current skills: ${JSON.stringify(skills.slice(0, 20).map((s) => ({ name: s.name, category: s.category, proficiency: s.proficiency })))}
Recent usage: ${JSON.stringify([...new Set(usage.slice(0, 30).map((u) => u.skill_name))])}`,
  };
