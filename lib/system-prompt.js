 ...
 *
 * @param {object} [opts]
 * @param {*} [opts.userProfile]
 * @param {string} [opts.personalityInstructions]
 * @param {string} [opts.relationshipContext]
 * @param {*} [opts.relationshipMemories]
 * @param {*} [opts.episodicMemories]
 * @param {string} [opts.memorySummaries]
 * @param {string} [opts.knowledgeGraphContext]
 * @param {*} [opts.recentConversation]
 * @param {string} [opts.semanticMemories]
 * @param {boolean} [opts.unfiltered]
 * @param {string} [opts.mediaMemoryContext]
 * @param {string} [opts.companionContext]
 * @param {string} [opts.aiMood]
