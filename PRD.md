...
> **Priority Directive**: This product must target a best-in-class global standard for AI UI/UX, with exceptionally smooth interaction design, premium responsiveness, and deeply human-like real-time conversation.  
...
- A **world-class AI experience** — best-in-class in both design and human-like interaction
- A **technologically superior product** — frictionless, immersive, and next-level
...
## 2. World-Class AI UX Standard — Top-Priority Product Requirement
...
- Every tap, swipe, press, and gesture must produce **immediate, satisfying, and predictable feedback**.
- Interactions must feel **zero-friction** — the interface should feel like it anticipates the user's intent.
- Turn-taking in conversation must feel **effortless and natural**, never requiring the user to wait or fight the interface.
- Interruptions must feel **natural** — the user can break in at any time and the system responds gracefully and instantly.

### 2.3 Motion and Transitions
- All motion must be **physics-based, purposeful, and cinematically polished** — never gratuitous or distracting.
- Transitions between states, screens, and modes must feel **seamless, elegant, and continuous** — no hard cuts, no flashes, no jarring shifts.
- Animation timing and easing must feel **organic and alive** — choreographed to create a sense of intelligence and intentionality.
- The motion language must communicate **premium craftsmanship** in every frame.

### 2.4 Response Speed
- Response timing must feel **immediate and alive** — the AI must never feel slow, disconnected, or buffering.
- The system must minimize all perceptible latency between user input and AI response.
- Visual feedback must begin **within milliseconds** of any user action — the system must always feel awake and ready.
- Voice response latency must be low enough that the conversation feels **genuinely real-time** — not request-response.

### 2.5 Conversation Realism
- The conversation experience must feel **deeply natural, highly responsive, and as human-like as possible** in pacing, flow, tone, and emotional presence.
- Dialogue must flow like talking to a thoughtful, intelligent person — not like issuing commands to a machine.
- The AI must handle pauses, interruptions, context shifts, and emotional nuance with the same grace a skilled human conversationalist would.
- The product must aim for a **world-class standard in conversational realism** — the AI should feel conversationally intelligent, emotionally aware, and highly engaging.

### 2.6 Emotional Presence
- The AI must feel **emotionally present, attentive, and aware** at all times — not robotic or transactional.
- The companion must convey warmth, personality, and genuine engagement through voice, animation, and response content.
- Emotional tone must adapt fluidly to context — supportive when needed, playful when appropriate, focused when required.
- The user must feel that the AI **cares** — the experience should foster trust, connection, and emotional resonance.

### 2.7 Premium Overall Feel
- The total product experience must feel **elite, premium, effortless, and best-in-class** — every detail matters.
- The product must never feel like a prototype, a demo, a wrapper around an API, or a generic chatbot shell.
- The combined effect of smoothness, speed, motion, conversation quality, and emotional presence must create a sense of **technological superiority** — the user should feel they are using something genuinely next-level.
- The product should feel like it was designed and built by the best team in the world, with no compromises.

> **Enforcement**: Any feature, screen, interaction, or behavior that does not meet the standards in this section must be flagged, prioritized, and resolved before production release. This is the non-negotiable quality floor.

---

## 3. Critical Missing Capabilities Now Required
...
The product experience must satisfy all of the following properties. These principles are **measured against the world-class standard defined in Section 2** — not against average industry norms:

1. **Alive** — The AI has visible presence. It is never static while idle. The interface breathes. Every pixel feels animated with purpose and intelligence.
2. **Immediate** — Voice response latency must feel real-time. The AI must feel instant. There must be zero perceptible delay between intent and response.
3. **Premium** — Every pixel is intentional. The visual bar is flagship-level. The product must feel more polished than any competing AI interface.
4. **Immersive** — The user is drawn into the experience. It does not feel like a utility. The interface creates a sense of presence and flow that is difficult to leave.
5. **Emotionally engaging** — The companion feels present, aware, and attentive. It reads the room. It responds with emotional intelligence.
6. **Technologically advanced** — The interface communicates next-generation AI capability. The user should feel they are interacting with the future.
7. **Natural in conversation** — Dialogue flows like talking to a person, not triggering commands. Turn-taking is effortless. Interruptions are graceful. Pacing feels human.
8. **Adaptive** — The interface automatically transforms to reflect the AI's current context and task.
9. **Frictionless** — Every interaction path is optimized to remove unnecessary steps, waits, and cognitive load. The product anticipates the user.
10. **Best-in-class** — Every element of the experience — from motion to voice to design — is held to a world-class standard. The product is designed to compete at the highest level of AI UX globally.

---

## 5. Live Talk and Real-Time Conversation Requirements
...
- **Turn-taking must feel effortless** — the user should never have to think about when or how to speak.
- **Interruptions must feel natural** — the AI gracefully yields when the user speaks, without lag or awkwardness.

### 5.2 Real-Time Voice Input
...
- **Response timing must feel immediate and alive** — the AI should feel like it is thinking and responding in real time, not processing a request.
- The user must be able to interrupt the AI while it is speaking without breaking the session.

### 5.4 Conversation Quality
...
- **The AI must feel conversationally intelligent, emotionally aware, and highly engaging** — not scripted, not robotic, not generic.
- Pacing, tone, and emotional presence must feel **as human-like as possible** — the conversation should feel deeply natural and alive.
- The conversation experience must meet the **world-class conversational realism standard** defined in Section 2.5.

---

## 6. Avatar Presence, Lip Sync, and Expressive Behavior Requirements

### 6.1 Persistent Avatar Presence
...
### 6.3 Expressive Facial Movement and Animation
...
### 6.4 State-Reactive Avatar Behavior
...
## 7. Photo and Video Generation Requirements

### 7.1 Realistic Photo Generation
...
### 7.2 Realistic Video Generation
...
### 7.3 Style and Identity Controls
...
## 8. UI / Visual Design System Requirements
...
- The UI must never feel clunky, delayed, stiff, overloaded, or generic — per the world-class standard in Section 2.
- **The overall visual impression must convey technological superiority** — the user should immediately sense they are using a best-in-class product.
...
### 8.4 Motion Design
All motion must be **purposeful, elegant, physics-based, and world-class** — this is a primary differentiator of the product:
...
### 8.6 Component Quality Standards
...
## 9. Home Screen and AI Core Behavior
...
### 9.3 Orb Animation Behavior by State
...
### 9.4 Sidebar Companion Integration
...
## 10. Dynamic State and Adaptive Workspace Requirements

### 10.1 State-Based Interface Transformation
...
### 10.2 Live Talk Adaptive Interface
...
## 11. Companion Behavior and Request-Handling Requirements

### 11.1 Cooperative, User-Aligned Behavior
...
### 11.2 Nuanced Handling of Sensitive Requests
...
### 11.3 Emotional Presence
- The companion must feel **present, attentive, emotionally aware, and responsive** — meeting the world-class standard defined in Section 2.6.
...
- Emotional tone must **adapt fluidly to context** — the AI must read the user's state and respond with appropriate warmth, energy, or focus.
- The companion must feel **emotionally intelligent and genuinely engaging** — never flat, scripted, or transactional.

### 11.4 Voice Conversation Persona
...
## 12. Performance and Latency Requirements

> **Performance is inseparable from the world-class UX standard.** Perceived speed and responsiveness are primary quality signals. Any perceptible lag, stutter, or delay is a quality failure that must be resolved.

### 12.1 Voice Interaction Performance
...
## 13. Technical Architecture Expectations

### 13.1 Voice Pipeline Architecture
...
### 13.3 Avatar and Animation Architecture
...
### 13.4 Media Generation Architecture
...
### 13.5 State Management Architecture
...
The following quality standards are required for production release. They are not aspirational — they are the acceptance threshold. **Every item must meet the world-class AI UX standard defined in Section 2.**
...
- [ ] The overall visual impression conveys world-class quality and technological superiority
...
- [ ] Interruption (tapping mic while AI speaks) stops playback immediately and feels natural
- [ ] State label updates accurately reflect the current AI state
- [ ] Transcript scrolls automatically to latest turn
- [ ] Turn-taking feels effortless — the user never fights the interface to speak or listen
- [ ] All interactions feel zero-friction, responsive, and satisfying

### 14.3 Conversation Quality
- [ ] Voice responses feel natural, warm, and human-like in pacing and tone
- [ ] Conversation pacing feels real-time — not request-response
- [ ] The AI feels conversationally intelligent, emotionally aware, and genuinely engaging
- [ ] Dialogue flows naturally with graceful handling of pauses, interruptions, and context shifts
- [ ] The conversation experience meets the world-class conversational realism standard (Section 2.5)
...
A feature is considered **Done** when all of the following are true **and** the feature meets the world-class AI UX standard defined in Section 2:
